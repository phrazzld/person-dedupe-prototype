...
export const PEOPLE: PersonSeed[] = [
  ...
  },
  {
    ...
    email: 'sarah.jimenez@example.com',
    phone: '555-201-1009',
    date_of_birth: '1985-03-14', // typo'd last digit
    address_line: '14 Birch Court',
    city: 'Denver',
    region: 'CO',
    postal_code: '80202',
  ...
  },
  {
    ...
    phone: '555-901-2000',
    date_of_birth: null, // newest record created without a DOB — keeps (b,c) in the LLM-adjudicated band
    address_line: '99 Bayshore Dr',
    city: 'Tampa',
    region: 'FL',
    postal_code: '33606',
